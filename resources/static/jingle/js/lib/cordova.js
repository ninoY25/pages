...
/**
* Contains information about a single contacts.
* @constructor
...
* @param {DOMString} birthday contacts's birthday
* @param {DOMString} note user notes about contacts
* @param {Array.<ContactField>} photos
* @param {Array.<ContactField>} categories
* @param {Array.<ContactField>} urls contacts's web sites
*/
...
/**
* Removes contacts from device storage.
...
* With the contacts ID set to null.
...
/**
* Persists contacts to device storage.
* @param successCB success callback
* @param errorCB error callback
*/
 ...
 * @param multiple boolean used to determine if more than one contacts should be returned
 */
...
var contacts = {
     ...
     * @param successCB success callback
     * @param errorCB error callback
     * @param {ContactFindOptions} options that can be applied to contacts searching
    ...
    /**
     * This function creates a new contacts, but it does not persist the contacts
     * to device storage. To persist the contacts to device storage, invoke
     * contacts.save().
