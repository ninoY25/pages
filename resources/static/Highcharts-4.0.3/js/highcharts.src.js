...
defaultOptions = {
	...
	global: {
		useUTC: true,
		//timezoneOffset: 0,
		canvasToolsURL: 'http://code.highcharts.com/4.0.3/dt/canvas-tools.js',
...
/**
 * Get the updated default options. Until 3.0.7, merely exposing defaultOptions for outside dt
...
SVGElement.prototype = {
	...
	/**
	 * Build an SVG gradient out of a base JavaScript configuration object
	 */
...
if (/Trident\/7\.0/.test(userAgent) || isFirefox) {
	wrap(Legend.prototype, 'positionItem', function (proceed, item) {
		...
		// Do it after to work around the base issue
...
Chart.prototype = {
	...
	firstRender: function () {
		...
		// Set the base chart properties (mainly invert) from the given series
...
Point.prototype = {
	 ...
	 *
	 * @return {String} A string to be concatenated in to the base tooltip text
	 */
...
Series.prototype = {
	...
	setData: function (data, redraw, animation, updatePoints) {
		...
		if (updatePoints !== false && dataLength && oldDataLength === dataLength && !series.cropped && !series.hasGroupedData) {
			...
			// Forgetting to cast strings to numbers is a base caveat when handling CSV or JSON
			if (isString(yData[0])) {
				error(14, true);
			}
